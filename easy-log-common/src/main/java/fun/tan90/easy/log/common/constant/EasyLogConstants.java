...
public interface EasyLogConstants {
    ...
    String COLLECTOR_SCAN_BASE_PACKAGES = "fun.tan90.easy.log.collector";

    String COMPUTE_SCAN_BASE_PACKAGES = "fun.tan90.easy.log.compute";

    String ADMIN_SCAN_BASE_PACKAGES = "fun.tan90.easy.log.admin";

    String CORE_SCAN_BASE_PACKAGES = "fun.tan90.easy.log.core";
    ...
    String LOG_REAL_TIME_FILTER_RULES = "LOG_REAL_TIME_FILTER_RULES:";
