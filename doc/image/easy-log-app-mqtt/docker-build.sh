...
# -t 后面为镜像名称和TAG
buildArg="--build-arg PROJECT_NAME=easy-log-app-mqtt --build-arg SERVER_PORT=1203 --build-arg MQTT_TCP_PORT=1883 --build-arg MQTT_WEBSOCKET_PORT=8083"
imageName="registry.cn-hangzhou.aliyuncs.com/tan90/easy-log-app-mqtt"
