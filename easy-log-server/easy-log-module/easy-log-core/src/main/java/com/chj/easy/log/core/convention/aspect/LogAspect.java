package com.chj.easy.log.core.convention.aspect;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.chj.easy.log.core.convention.annotation.Log) || @within(org.springframework.web.bind.annotation.RestController)")
