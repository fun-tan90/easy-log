package com.chj.easy.log.server.common.convention.page.es;

import com.chj.easy.log.server.common.convention.page.BasePage;
import lombok.Data;
...
@Data
@NoArgsConstructor
public class EsPageInfo<T> extends BasePage<T> {
